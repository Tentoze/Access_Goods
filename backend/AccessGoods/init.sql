...
INSERT INTO item (item_id, name, cost, description, is_active, account_id)
VALUES (1, 'Laptop', 1500.00, 'High-performance laptop', true, 1),
       (2, 'T-shirt', 20.99, 'Cotton T-shirt', true, 2),
       (3, 'Java Book', 39.99, 'Introduction to Java programming', true, 3);
